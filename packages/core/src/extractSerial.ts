...
const SERIAL_PREFIX_PATTERNS =
  /(US\d{6,9}[A-Z]?|MX\d{8}[A-Z]?|MN\d{5,7}|MZ\d{5,7}|JD\d{8}|CZ\d{5,6}|DN\d{5,6}|D?Z\d{6,7}|VS\d{6}|HR\d{5,6}|CS\d{3,6}|S2\d{6,7}|CE\d{4,6}|CTI[A-Z]\d{4,6}|I[A-E]\d{4,6}|V\d{4,7}|HC\d{4,7})/;
